...
latex_documents = [
    ("index", "grakel.tex", "GraKeL Documentation", "Yannis Siglidis", "manual"),
]
...
man_pages = [("index", "grakel", "GraKeL Documentation", ["Yannis Siglidis"], 1)]
...
texinfo_documents = [
    ("index", "grakel", "GraKeL Documentation", "Yannis Siglidis", "GraKeL", "A library for graph kernels.", "Machine-Learning"),
]
...
linkcode_resolve = make_linkcode_resolve(
    "grakel", "https://github.com/ysig/GraKeL" "/blob/{revision}/" "{package}/{path}#L{lineno}"
)
